...
class simpleMVCdevelBar_viewHelper extends  jsPlugin_viewHelper{
	...
	function simpleMVCdevelBar($dynCss=null){
		...
		.'<button id="sMVCcssEditor" class="ui-button ui-button-tag" onclick="window.open(\''.ROOT_URL.'/js/CodeMirror-0.65/cssEditor.php?editorId='.FRONT_NAME.'\',\'cssEditor\',\'dependent=yes,titlebar=no,status=no,scrollbars=yes,menubar=no,location=yes,toolbar=no,height=600,width=800\');" >cssEditor</button>'
